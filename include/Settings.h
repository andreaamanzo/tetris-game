...
namespace Settings
{
  ...
  inline constexpr float next_tet_x{ board_w + size };
  inline constexpr float next_tet_y{ size };
  inline constexpr float score_text_x{ next_tet_x };
  inline constexpr float score_text_y{ size * 7 };
}
